...
START_TEST(test1) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "Do it more than  |%10.7d|\n", 16384);
  sprintf(buffer2, "Do it more than  |%10.7d|\n", 16384);
...
START_TEST(test5) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "Do it more than  |%10.0d|\n", 0);
  sprintf(buffer2, "Do it more than  |%10.0d|\n", 0);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test9) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "Do it more than  |%10.d|\n", 0);
  sprintf(buffer2, "Do it more than  |%10.d|\n", 0);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test13) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "Do it more than  |%.7d|\n", 16384);
  sprintf(buffer2, "Do it more than  |%.7d|\n", 16384);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test17) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "Do it more than  |%.0d|\n", 0);
  sprintf(buffer2, "Do it more than  |%.0d|\n", 0);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test21) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "Do it more than  |%.d|\n", 0);
  sprintf(buffer2, "Do it more than  |%.d|\n", 0);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test29) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "Do it more than  |%+3.0d|\n", 0);
  sprintf(buffer2, "Do it more than  |%+3.0d|\n", 0);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test33) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "Do it more than  |%+3.d|\n", 0);
  sprintf(buffer2, "Do it more than  |%+3.d|\n", 0);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test73) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "Do it more than  |%.3d|\n", 42517);
  sprintf(buffer2, "Do it more than  |%.3d|\n", 42517);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test85) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "Do it more than  |%10.3d|\n", 42517);
  sprintf(buffer2, "Do it more than  |%10.3d|\n", 42517);
  ck_assert_str_eq(buffer1, buffer2);
}
...
Suite *s21_sprintf_test_suite_specifier_d_2() {
  Suite *s = suite_create("\033[45m| s21_sprintf_test specifier d 2 |\033[0m");
