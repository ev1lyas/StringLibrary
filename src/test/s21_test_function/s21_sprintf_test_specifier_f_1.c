...
START_TEST(test1) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %f times to go", 123.456);
  sprintf(buffer2, "I have %f times to go", 123.456);
...
START_TEST(test5) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %#f times to go", 123.);
  sprintf(buffer2, "I have %#f times to go", 123.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test7) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %0f times to go", 123.456);
  sprintf(buffer2, "I have %0f times to go", 123.456);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test9) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %0 f times to go", 123.456);
  sprintf(buffer2, "I have %0 f times to go", 123.456);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test19) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %10f times to go", 123.456);
  sprintf(buffer2, "I have %10f times to go", 123.456);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test23) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %#10f times to go", 123.);
  sprintf(buffer2, "I have %#10f times to go", 123.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test25) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %010f times to go", 123.456);
  sprintf(buffer2, "I have %010f times to go", 123.456);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test27) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %0 10f times to go", 123.456);
  sprintf(buffer2, "I have %0 10f times to go", 123.456);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test49) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %-10f times to go", 0.00123456789);
  sprintf(buffer2, "I have %-10f times to go", 0.00123456789);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test51) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %.8f times to go", -0.00000123456789);
  sprintf(buffer2, "I have %.8f times to go", -0.00000123456789);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test52) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %.12f times to go", -0.00000123456789);
  sprintf(buffer2, "I have %.12f times to go", -0.00000123456789);
  ck_assert_str_eq(buffer1, buffer2);
}

Suite *s21_sprintf_test_suite_specifier_f_1() {
  Suite *s = suite_create("\033[45m| s21_sprintf_test specifier f 1 |\033[0m");
