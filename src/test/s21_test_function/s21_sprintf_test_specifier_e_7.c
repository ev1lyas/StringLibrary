...
START_TEST(test1) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I have %.9e times to go", 123.456789123);
  sprintf(buffer2, "I have %.9e times to go", 123.456789123);
...
START_TEST(test17) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I have %0.9e times to go", 123.456789123);
  sprintf(buffer2, "I have %0.9e times to go", 123.456789123);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test37) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I have %20.9e times to go", 123.456789123);
  sprintf(buffer2, "I have %20.9e times to go", 123.456789123);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test53) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I have %020.9e times to go", 123.456789123);
  sprintf(buffer2, "I have %020.9e times to go", 123.456789123);
  ck_assert_str_eq(buffer1, buffer2);
}
...
Suite *s21_sprintf_test_suite_specifier_e_7() {
  Suite *s = suite_create("\033[45m| s21_sprintf_test specifier e 7 |\033[0m");
