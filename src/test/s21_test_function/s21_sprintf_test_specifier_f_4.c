...
START_TEST(test1) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %20.3f times to go", 26704.45167);
  sprintf(buffer2, "I have %20.3f times to go", 26704.45167);
...
START_TEST(test9) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %020.3f times to go", 26704.45167);
  sprintf(buffer2, "I have %020.3f times to go", 26704.45167);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test23) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %20.0f times to go", 0.);
  sprintf(buffer2, "I have %20.0f times to go", 0.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test31) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %020.0f times to go", 0.);
  sprintf(buffer2, "I have %020.0f times to go", 0.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test37) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %20.f times to go", 0.);
  sprintf(buffer2, "I have %20.f times to go", 0.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test45) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %020.f times to go", 0.);
  sprintf(buffer2, "I have %020.f times to go", 0.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test55) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %20.f times to go", 26704.45167);
  sprintf(buffer2, "I have %20.f times to go", 26704.45167);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test63) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %020.f times to go", 26704.45167);
  sprintf(buffer2, "I have %020.f times to go", 26704.45167);
  ck_assert_str_eq(buffer1, buffer2);
}
...
Suite *s21_sprintf_test_suite_specifier_f_4() {
  Suite *s = suite_create("\033[45m| s21_sprintf_test specifier f 4 |\033[0m");
