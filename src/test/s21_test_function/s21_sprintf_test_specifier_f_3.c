...
START_TEST(test1) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %Lf times to go", 123.456L);
  sprintf(buffer2, "I have %Lf times to go", 123.456L);
...
START_TEST(test5) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %#Lf times to go", 123.L);
  sprintf(buffer2, "I have %#Lf times to go", 123.L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test7) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %0Lf times to go", 123.456L);
  sprintf(buffer2, "I have %0Lf times to go", 123.456L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test9) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %0 Lf times to go", 123.456L);
  sprintf(buffer2, "I have %0 Lf times to go", 123.456L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test19) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %10Lf times to go", 123.456L);
  sprintf(buffer2, "I have %10Lf times to go", 123.456L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test23) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %#10Lf times to go", 123.L);
  sprintf(buffer2, "I have %#10Lf times to go", 123.L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test25) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %010Lf times to go", 123.456L);
  sprintf(buffer2, "I have %010Lf times to go", 123.456L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test27) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %0 10Lf times to go", 123.456L);
  sprintf(buffer2, "I have %0 10Lf times to go", 123.456L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
Suite *s21_sprintf_test_suite_specifier_f_3() {
  Suite *s = suite_create("\033[45m| s21_sprintf_test specifier f 3 |\033[0m");
