...
START_TEST(test25) {
  char buffer1[8000] = {'\0'};
  char buffer2[8000] = {'\0'};
  s21_sprintf(buffer1, "I have %0g times to go", 12345678.12345678);
  sprintf(buffer2, "I have %0g times to go", 12345678.12345678);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test27) {
  char buffer1[8000] = {'\0'};
  char buffer2[8000] = {'\0'};
  s21_sprintf(buffer1, "I have %015g times to go", 12345678.12345678);
  sprintf(buffer2, "I have %015g times to go", 12345678.12345678);
  ck_assert_str_eq(buffer1, buffer2);
}
...
Suite *s21_sprintf_test_suite_specifier_g_5() {
  Suite *s = suite_create("\033[45m| s21_sprintf_test specifier g 5 |\033[0m");
