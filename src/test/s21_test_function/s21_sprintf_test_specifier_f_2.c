...
START_TEST(test1) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %.0f times to go", 0.);
  sprintf(buffer2, "I have %.0f times to go", 0.);
...
START_TEST(test2) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %.f times to go", 0.);
  sprintf(buffer2, "I have %.f times to go", 0.);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test17) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %.8f times to go", 45167.16384);
  sprintf(buffer2, "I have %.8f times to go", 45167.16384);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test25) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %0.8f times to go", 45167.16384);
  sprintf(buffer2, "I have %0.8f times to go", 45167.16384);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test40) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %.2f times to go", 45167.16384);
  sprintf(buffer2, "I have %.2f times to go", 45167.16384);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test48) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %0.2f times to go", 45167.16384);
  sprintf(buffer2, "I have %0.2f times to go", 45167.16384);
  ck_assert_str_eq(buffer1, buffer2);
}
...
Suite *s21_sprintf_test_suite_specifier_f_2() {
  Suite *s = suite_create("\033[45m| s21_sprintf_test specifier f 2 |\033[0m");
