...
START_TEST(test1) {
  ...
  char buffer2[8000] = {0};
  short x = 32500;
  s21_sprintf(buffer1, "I have %hd times to go", x);
  sprintf(buffer2, "I have %hd times to go", x);
...
START_TEST(test9) {
  ...
  char buffer2[8000] = {0};
  short x = 32500;
  s21_sprintf(buffer1, "I have %0hd times to go", x);
  sprintf(buffer2, "I have %0hd times to go", x);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test13) {
  ...
  char buffer2[8000] = {0};
  short x = 32500;
  s21_sprintf(buffer1, "I have %12hd times to go", x);
  sprintf(buffer2, "I have %12hd times to go", x);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test21) {
  ...
  char buffer2[8000] = {0};
  short x = 32500;
  s21_sprintf(buffer1, "I have %012hd times to go", x);
  sprintf(buffer2, "I have %012hd times to go", x);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test27) {
  ...
  s21_sprintf(buffer1, "I have %ld times to go", 32500L);
  sprintf(buffer2, "I have %ld times to go", 32500L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test29) {
  ...
  s21_sprintf(buffer1, "I have %ld times to go", 8223372036854775807L);
  sprintf(buffer2, "I have %ld times to go", 8223372036854775807L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test35) {
  ...
  s21_sprintf(buffer1, "I have %0ld times to go", 32500L);
  sprintf(buffer2, "I have %0ld times to go", 32500L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test39) {
  ...
  s21_sprintf(buffer1, "I have %12ld times to go", 32500L);
  sprintf(buffer2, "I have %12ld times to go", 32500L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test41) {
  ...
  s21_sprintf(buffer1, "I have %12ld times to go", 8223372036854775807L);
  sprintf(buffer2, "I have %12ld times to go", 8223372036854775807L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test47) {
  ...
  s21_sprintf(buffer1, "I have %012ld times to go", 32500L);
  sprintf(buffer2, "I have %012ld times to go", 32500L);
  ck_assert_str_eq(buffer1, buffer2);
}
...
Suite *s21_sprintf_test_suite_specifier_d_3() {
  Suite *s = suite_create("\033[45m| s21_sprintf_test specifier d 3 |\033[0m");
