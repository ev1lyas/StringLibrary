...
START_TEST(test1) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I have %.15e times to go", 0.0000000000000123456789);
  sprintf(buffer2, "I have %.15e times to go", 0.0000000000000123456789);
...
START_TEST(test17) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I have %0.15e times to go", 0.0000000000000123456789);
  sprintf(buffer2, "I have %0.15e times to go", 0.0000000000000123456789);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test31) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %# 0.15e times to go",
...
START_TEST(test37) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I have %20.15e times to go", 0.0000000000000123456789);
  sprintf(buffer2, "I have %20.15e times to go", 0.0000000000000123456789);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test43) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %+20.15e times to go",
              -0.0000000000000123456789);
  sprintf(buffer2, "I have %+20.15e times to go", -0.0000000000000123456789);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test53) {
  char buffer1[8000] = {'0'};
  char buffer2[8000] = {'0'};
  s21_sprintf(buffer1, "I have %020.15e times to go", 0.0000000000000123456789);
  sprintf(buffer2, "I have %020.15e times to go", 0.0000000000000123456789);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test55) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %020.15e times to go",
              -0.0000000000000123456789);
  sprintf(buffer2, "I have %020.15e times to go", -0.0000000000000123456789);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test89) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  s21_sprintf(buffer1, "I have %E times to go", 0.00009);
  sprintf(buffer2, "I have %E times to go", 0.00009);
  ck_assert_str_eq(buffer1, buffer2);
}
...
START_TEST(test90) {
  char buffer1[8000] = {0};
  char buffer2[8000] = {0};
  sprintf(buffer1, "I have %LE times to go", 1.79769e+308L);
  sprintf(buffer2, "I have %LE times to go", 1.79769e+308L);
  ck_assert_str_eq(buffer1, buffer2);
}

Suite *s21_sprintf_test_suite_specifier_e_9() {
  Suite *s = suite_create("\033[45m| s21_sprintf_test specifier e 9 |\033[0m");
